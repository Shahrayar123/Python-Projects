...
if __name__ == '__main__':
    ...
    Typhlosion = Pokemon('Typhlosion', 'Fire', ['Lava Plume', 'Flamethrower', 'Rollout', 'OverHeat'], {'ATTACK':12, 'DEFENSE': 8})
    ...
    Cyndaquil = Pokemon('Cyndaquil', 'Fire', ['Ember', 'Quick Attack', 'Smokescreen', 'Tackle'], {'ATTACK': 4, 'DEFENSE': 2})
    ...
    Quilava = Pokemon('Quilava', 'Fire', ['Flame Wheel', 'Quick Attack', 'Swift', 'Flame CHarge'], {'ATTACK': 6, 'DEFENSE': 5})
